# This is the main Streamlit entry point for the GA4 AI Analytics Platform.
# It loads GA4 reports, lets users scope data, and routes questions to the AI.
...
# Page Configuration
# ============================================================================
# This section sets the Streamlit page title and layout.

st.set_page_config(
    page_title="GA4 AI Analytics Platform",                                  # Browser tab title
