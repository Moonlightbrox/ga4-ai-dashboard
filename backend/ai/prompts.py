...
BUTTON_PROMPTS = {                                                          # Map of button IDs to detailed prompt text
    ...
    "landing_page_optimization": (
        ...
        "\n"
        "TARGET REPORTS:\n"
        "For each report, follow the filter logic and use the analysis philosophy and related core principle to guide the content\n"
        "- High Users + Low Purchase Revenue: Show all pages where Total Users is High and Purchase Revenue Low.\n"
        "- High Revenue per User + Low Total Users: Show all pages where Revenue per User is High and Total Users is Low.\n"
        "\n"
        "OUTPUT AS ANALYSIS BLOCKS:\n"
        "For each target report output one block in this exact structure (use analysis philosophy and core principles to guide the content):\n"
        "## Report: <name>\n"
        "### Table\n"
        "<markdown table>\n"
        "### Insights\n"
        ...
        "- Pages with high Revenue per User and low Total Users may represent scalable opportunities.\n"
        "\n"
    ),
}
